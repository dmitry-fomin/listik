...
а маршруты роя, пайплайны роя и прямые харнессы, которых нет в файле, остаются и встают после
...
перезаписи правки пайплайнов на доске пропадут, а маршруты роя и прямых харнессов, которых нет
