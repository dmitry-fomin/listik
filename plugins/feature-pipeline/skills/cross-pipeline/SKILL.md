...
таким же коротким прогоном, как в `xlow-pipeline`:
...
существующем коде надо проверить до старта, и покрывает ли раздел «Проверки порции» всё, что порция затрагивает.
=== ТЗ порции ===
