...
0.343) за +$0.46 (это замеры Grok 4.6; для 4.7 замеров ещё нет), и в этом пресете надбавку не платят. Второе следствие — со стороны ТЗ: писатель
