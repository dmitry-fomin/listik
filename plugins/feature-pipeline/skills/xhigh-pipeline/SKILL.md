...
`opus` + `xhigh`, и здесь его **перебивают параметром `model: opus` в вызове**: так и получается Opus xhigh —
`model` перебивает frontmatter, усилие остаётся из него. У исполнителя
