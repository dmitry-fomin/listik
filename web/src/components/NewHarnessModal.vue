 ...
 * исполнитель, которого ставят держателем прямого маршрута и исполнителем роли
 * роя. Держатель на сервере — `agent:<ключ>`: ключ уходит явно и потом не
 ...
 * прямого маршрута (`submit-disabled` на кнопке `form="…"`).
 */
...
<template>
  ...
  >
    <p class="listik-new-harness__lead listik-new-harness__anchor">
      Харнесс — исполнитель, которого ставят держателем прямого маршрута и исполнителем роли роя.
