 ...
 * края — в моноширинной подписи остаётся только ключ. Порядок и удаление маршрута модели данных не принадлежат:
...
.listik-routes-settings__layout {
  display: grid;
  /* Списку хватает 240px: в строке только название, ключ и пилюли — остальное
     место отдаём карточке справа. */
