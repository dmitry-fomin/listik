/**
 * Тёмная тема по умолчанию + переключатель. Цветовой гаммы в приложении нет
 * (переключатель гаммы убран вместе со вкладкой «Оформление»):
 * файл ведает единственной осью — светлая/тёмная (`data-theme` на <html>),
 * которую кит читает сам.
 */
